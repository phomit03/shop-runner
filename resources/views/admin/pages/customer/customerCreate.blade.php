...
@section('title', "Customer Create - Forms")
    ...
    <div class="row">
        ...
        <div class="col-sm-10 mx-auto">
            ...
            <div class="card card-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{url('admin/customer/create')}}" enctype="multipart/form-data"> {{--enctype: cho phep uploads file--}}
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('idCustomer')}}" name="idCustomer" class="form-control" placeholder="AUTO_INCREMENT	KEY..." disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('nameCustomer')}}" name="nameCustomer" class="form-control" placeholder="Input Customer Name..." required>
                            <div>
                                @error('nameCustomer')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('phoneCustomer')}}" name="phoneCustomer" class="form-control" placeholder="Input Customer Phone Number..." required>
                            <div>
                                @error('phoneCustomer')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" value="{{old('emailCustomer')}}" name="emailCustomer" class="form-control" placeholder="Input Customer Email..." required>
                            <div>
                                @error('emailCustomer')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" value="{{old('addressCustomer')}}" name="addressCustomer" class="form-control" placeholder="Input Customer Address..." rows="2" required></textarea>
                            <div>
                                @error('addressCustomer')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                        </div>
