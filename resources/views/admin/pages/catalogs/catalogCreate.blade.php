...
@section('title', "Catalog Create - Forms")
...
@section('content-header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Catalog Forms - Create</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Forms</a></li>
                <li class="breadcrumb-item active">Catalog Create</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="row">
        ...
        <div class="col-sm-10 mx-auto">
            ...
            <div class="card card-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{url('admin/catalogs/create')}}" enctype="multipart/form-data"> {{--enctype: cho phep uploads file--}}
                    @csrf   <!--sinh ra 1 key token co thoi han nhat dinh, tranh bi tan cong may chu (bat buoc cho: POST, PUT, DELETE)-->
                    @method("post")
                    <div class="card-body">
                        <div class="form-group">
                            <label>Catalog ID <span style="color: red">*</span></label>
                            {{--value="{{old('studentID')}}": giữ nguyên giá trị ban đầu nếu add bị lỗi, thì không render--}}
                            <input type="text" value="{{old('idCatalog')}}" name="idCatalog" class="form-control" placeholder="AUTO_INCREMENT KEY..." disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('nameCatalog')}}" name="nameCatalog" class="form-control" placeholder="Input Catalog Name..." required>
                            <div>
                                @error('nameCatalog')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('idAdvanced')}}" name="idAdvanced" class="form-control" placeholder="Input Advanced ID...">
                            <div>
                                @error('idAdvanced')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                    ...
                    <div class="card-footer col-md-12 text-center">
                        ...
                        <a href="admin/catalogs/list"><button type="button" class="btn btn-info float-right">Back List</button></a>
                    </div>
                </form>
            </div>
            <!-- /.card -->
